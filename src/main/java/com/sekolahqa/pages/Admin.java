...
public class Admin extends BasePage{
    private By btnAdmin = new By.ByXPath("//*[@id=\"menu_admin_viewAdminModule\"]");
    ...
    private By errorUsernameAlreadyExists = new By.ByXPath("//*[@id=\"frmSystemUser\"]/fieldset/ol/li[3]/span");
    private By errorConfirmPasswordWrong = new By.ByXPath("//*[@id=\"frmSystemUser\"]/fieldset/ol/li[7]/span");
    ...
    public void errorMessageUsernameAlreadyExist() throws InterruptedException {
        waitUntilElementIsVisible(errorUsernameAlreadyExists);
    }
    public void errorMessageConfirmPasswordWrong() throws InterruptedException {
        waitUntilElementIsVisible(errorConfirmPasswordWrong);
    }
